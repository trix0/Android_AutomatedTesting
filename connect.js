...
async function fnLoginTest(client){
  ...
  try{
    let loginClick= await fnClick(imgLoginEmail,client,5,"Email button",500);
    let confirmAge = await fnClick(imgloginAgeConfirmYes,client,5,"Confirm Age button",2000);
    let enterEmail = await fnClick(imgloginEnterEmail,client,5,"Enter Email",1200);
    client.keys("matusko.satara@gmail.com");
    let hideKeyboard = await fnClearKeyBoard(client);
    let clickNext = await fnClick(imgloginYellowNextButton,client,5,"Next",500);
    let enterPassword = await fnClick(imgLoginPassword,client,5,"enter Password",2000);
    client.keys("123123");
    let hideKeyboard2 = await fnClearKeyBoard(client);
    let clickNext2 = await fnClick(imgloginYellowNextButton,client,5,"Next",500);
    let acceptConditions = await fnClick(imgloginAcceptConditions,client,5,"Accept Conditions",500);
    let clickNext3 = await fnClick(imgloginYellowNextButton,client,5,"Next",500);
    let clickNext4 = await fnClick(imgloginPassed,client,5,"x",500);
    let loadingWait = await fnIsOnScreen(imgFriendsForEverX,client,25,"waiting for another loading",2000);
    let clickNext5 = await fnClick(imgFriendsForEverX,client,5,"x",500);
    let clickNext6 = await fnClick(imgSettingsButton,client,5,"settings Button",500);
    let clickNext7 = await fnClick(imgLogOutButton,client,5,"Logout Button",500);
    let clickNext8 = await fnClick(imgBigOkButton,client,5,"big ok Button",500);
    let passed = await fnIsOnScreen(imgloginPassLogout,client,20,"if on scree then test passed",2000);
    let takeScreenShot= await fnSaveScreenShot(client);
    client.end();
  }
  catch(err){
    client.end();
...
async function fnLoginTest2(client){
  console.log("Login test running");
  try{
    let loginClick= await fnClick(img3,client,5,"login button",500);
    let EmailClick= await fnClick(imgLoginEmail,client,5,"Email button",500);
    let confirmAge = await fnClick(imgloginAgeConfirmYes,client,5,"Confirm Age button",2000);
    let enterEmail = await fnClick(imgloginEnterEmail,client,5,"Enter Email",1200);
    client.keys("matusko.satara@gmail.com");
    let hideKeyboard = await fnClearKeyBoard(client);
    ...
    let hideKeyboard2 = await fnClearKeyBoard(client);
    let clickNext2 = await fnClick(imgloginYellowNextButton,client,5,"Next",500);
    let clickNext3 = await fnClick(imgFriendsForEverX,client,10,"x",500);
    let clickNext4 = await fnClick(imgSettingsButton,client,5,"settings Button",500);
    let clickNext5 = await fnClick(imgLogOutButton,client,5,"Logout Button",500);
    let clickNext6 = await fnClick(imgBigOkButton,client,5,"big ok Button",500);
    let passed2 = await fnIsOnScreen(imgloginPassLogout,client,20,"if on scree then test passed",2000);
    let takeScreenShot= await fnSaveScreenShot(client);
    client.end();
  }
  catch(err){
